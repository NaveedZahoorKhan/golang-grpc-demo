...
type Storage struct {
	Driver               Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=example.com.Storage_Driver" json:"driver,omitempty"`
...
func init() {
	proto.RegisterEnum("example.com.Storage_Driver", Storage_Driver_name, Storage_Driver_value)
	proto.RegisterType((*Storage)(nil), "example.com.Storage")
}
...
var fileDescriptor_170f09d838bd8a04 = []byte{
	...
	0xc9, 0x17, 0xe2, 0x4e, 0xad, 0x48, 0xcc, 0x2d, 0xc8, 0x49, 0xd5, 0x4b, 0xce, 0xcf, 0x95, 0x12,
	...
	0x01, 0x46, 0x10, 0x23, 0xd8, 0xc5, 0x45, 0x80, 0xc9, 0x89, 0x25, 0x8a, 0xa9, 0x20, 0x29, 0x89,
	0x0d, 0xec, 0x46, 0x63, 0x40, 0x00, 0x00, 0x00, 0xff, 0xff, 0x5e, 0x81, 0xa0, 0x0e, 0xdf, 0x00,
	0x00, 0x00,
}
